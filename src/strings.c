...
const u8 gText_ProfOliveMatchCallName[] = _("PROF. OLIVE");
...
const u8 gText_OliveBoy[] = _("BOY");
const u8 gText_OliveGirl[] = _("GIRL");
...
const u8 gText_ProfOliveMatchCallDesc[] = _("{PKMN} PROF.");
