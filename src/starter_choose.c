...
const u32 gOliveBagTilemap[] = INCGFX_U32("graphics/starter_choose/olive_bag.bin", ".lz");
const u32 gOliveGrassTilemap[] = INCGFX_U32("graphics/starter_choose/olive_grass.bin", ".lz");
const u32 gOliveBagGrass_Gfx[] = INCGFX_U32("graphics/starter_choose/tiles.png", ".4bpp.lz");
...
void CB2_ChooseStarter(void)
{
    ...
    LZ77UnCompVram(gOliveBagGrass_Gfx, (void *)VRAM);
    LZ77UnCompVram(gOliveBagTilemap, (void *)(BG_SCREEN_ADDR(6)));
    LZ77UnCompVram(gOliveGrassTilemap, (void *)(BG_SCREEN_ADDR(7)));
