...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    [SPECIES_MONOBERUS] =
    {
        ...
        .expYield           = 62,
        .evYield_SpAttack   = 1,
        .genderRatio        = PERCENT_FEMALE(12.5), // Standard starter 87.5% Male / 12.5% Female
        .eggCycles          = 20,
        .friendship         = STANDARD_FRIENDSHIP,
        .growthRate         = GROWTH_MEDIUM_SLOW,
        .eggGroups          = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities          = { ABILITY_STRONG_JAW, ABILITY_STRONG_JAW }, // Or your custom ABILITY_SOUL_DRAIN
        .bodyColor          = BODY_COLOR_BLACK,
        .noFlip             = FALSE,
    },
};
